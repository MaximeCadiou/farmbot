...
/**
 * This is the item provider adapter for a {@link farmbot.modeling.farmbot_modeling.Move} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MoveItemProvider extends SequenceCommandItemProvider {
	/**
	...
	protected void addXPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Move_x_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Move_x_feature", "_UI_Move_type"),
						Farmbot_modelingPackage.Literals.MOVE__X, true, false, false,
	...
	protected void addYPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Move_y_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Move_y_feature", "_UI_Move_type"),
						Farmbot_modelingPackage.Literals.MOVE__Y, true, false, false,
						ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
	}
	...
	protected void addZPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Move_z_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Move_z_feature", "_UI_Move_type"),
						Farmbot_modelingPackage.Literals.MOVE__Z, true, false, false,
						ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
	}
	...
	public String getText(Object object) {
		...
		return getString("_UI_Move_type") + " " + move.getX();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		case Farmbot_modelingPackage.MOVE__X:
		case Farmbot_modelingPackage.MOVE__Y:
		case Farmbot_modelingPackage.MOVE__Z:
