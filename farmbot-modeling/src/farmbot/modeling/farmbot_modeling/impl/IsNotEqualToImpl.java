...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Is Not Equal To</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link farmbot.modeling.farmbot_modeling.impl.IsNotEqualToImpl#getValue <em>Value</em>}</li>
 *   <li>{@link farmbot.modeling.farmbot_modeling.impl.IsNotEqualToImpl#getAxe <em>Axe</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IsNotEqualToImpl extends BooleanExpressionImpl implements IsNotEqualTo {
	/**
	...
	protected EClass eStaticClass() {
		return Farmbot_modelingPackage.Literals.IS_NOT_EQUAL_TO;
	}
	...
	public void setValue(int newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Farmbot_modelingPackage.IS_NOT_EQUAL_TO__VALUE,
					oldValue, value));
	}
	...
	public void setAxe(String newAxe) {
		...
		axe = newAxe;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Farmbot_modelingPackage.IS_NOT_EQUAL_TO__AXE, oldAxe,
					axe));
	}
