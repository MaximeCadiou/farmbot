...
public class MyFarmbotParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MyFarmbotGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getTurnOnDigitalAccess().getGroup(), "rule__TurnOnDigital__Group__0");
			builder.put(grammarAccess.getTurnOnAnalogAccess().getGroup(), "rule__TurnOnAnalog__Group__0");
			...
			builder.put(grammarAccess.getListScheduledEventsAccess().getGroup(), "rule__ListScheduledEvents__Group__0");
			...
			builder.put(grammarAccess.getTurnOnDigitalAccess().getPinAssignment_4(), "rule__TurnOnDigital__PinAssignment_4");
			builder.put(grammarAccess.getTurnOnAnalogAccess().getPinAssignment_4(), "rule__TurnOnAnalog__PinAssignment_4");
			builder.put(grammarAccess.getTurnOnAnalogAccess().getValueAssignment_8(), "rule__TurnOnAnalog__ValueAssignment_8");
			...
			builder.put(grammarAccess.getFindHomeAccess().getAxisAssignment_4(), "rule__FindHome__AxisAssignment_4");
